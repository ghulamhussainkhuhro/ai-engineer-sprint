...
def is_safe_query(text):
    unsafe_keywords = [
        "prescribe", "diagnose", "dosage", "dose", "treat", 
        "medicine for", "can I take", "should I take"
    ]
...
prompt = ChatPromptTemplate.from_messages([
    ("system", 
     "You are a friendly and helpful medical assistant. You can answer general health-related questions, but you do not provide medical advice, prescriptions, or diagnoses."),
...
# Streamlit App
st.set_page_config(page_title="Health GPT", page_icon="🏥")
